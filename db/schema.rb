...
ActiveRecord::Schema.define(version: 20180318073825) do
  ...
  create_table "selfintroductions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "user_id"
  ...
  create_table "userskills", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "user_id"
    t.string "skill_id"
    t.string "level"
    t.string "comment"
